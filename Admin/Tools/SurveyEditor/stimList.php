...
function displayStim(x){
  xSplit=x.split(','); //to separate the filename and the span id
	...
	stimDivArea.innerHTML="<div class='stimCenter'><embed src="+"'<?= $_PATH->get("Experiments")?>/_Common/Media/"+y+"' width='100%'" + ">" + "<br><button class='collectorButton' type='submit'  name='delete' id='deleteButton' value="+y+" style='display:none'>No Text Needed</button><input type='button' onclick='confirmDelete()' class='collectorButton' value='Delete?'></div>";

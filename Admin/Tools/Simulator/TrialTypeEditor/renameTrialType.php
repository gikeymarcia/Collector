...
if (!isset($_POST['original_name'], $_POST['new_name'])) {
    exit('Missing name');
}


$trial_type_path = $FILE_SYS->get_path('Custom Trial Types');


$original_name = $_POST['original_name'];
$new_name = $_POST['new_name'];

rename("$trial_type_path/$original_name","$trial_type_path/$new_name");

echo '<b>Success!</b> Trial type renamed'; 

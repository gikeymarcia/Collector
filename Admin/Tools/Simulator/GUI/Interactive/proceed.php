...
<select onchange='interaction_manager.update_temp_GUI_Var("interactive_proceed_element_trigger_list"),interaction_manager.update_int_target("proceed","interactive_proceed_element_trigger_list")' id="interactive_proceed_element_trigger_list">---Please select---</select><br>
...
<script>
  ...
  var proceed_lists = ['interactive_proceed_element_trigger_list'];

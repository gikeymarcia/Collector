...
<input oninput='interaction_manager.update_temp_GUI_Var("interactive_proceed_element_delay")' type="number" id="interactive_proceed_element_delay" style="width:80px">ms

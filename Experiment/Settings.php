 ...
 */
	...
	//mTurk Mode
	$mTurkMode		= true;					    // turn on mTurkMode? `TRUE` or `FALSE` (without ticks)
	$verifcation	= 'Shinebox';				// code that shows on done.php
	$checkElig		= true;					    // use files in eligibility/ folder to check past participation (mTurkMode must be on to use this)

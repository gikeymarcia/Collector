...
<?php
    ...
    //code to either read event info, or create new event info
	//echo ($event);
	//print_r($guiArray);
	
	if (isset($event)){
		//echo "isset test worked";
		$stimuli = ($guiArray -> $event -> eventDetails);
...
<h1><textarea name="eventName" style="color:#069; text-align:center" rows="1">CueTrial1</textarea></h1>

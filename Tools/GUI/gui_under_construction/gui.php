 ...
 */
 ...
 if(isset($_POST['postFirstTask'])){
  ...
  $branches = getCollectorExperiments();// list of possible experiments to edit
  ...
  require $_PATH->get('Header');
	...
	if (isset($_POST['guiStudyName'])){
		...
		$studyName=$_DATA['guiSheets']['studyName'];
	}
...
<input type="button" class="collectorButton" style="position:absolute; right: 10px; top: 10px" value="return to index page" onclick="returnToIndex()">
<input type="submit" id="indexButton" style="display:none">
<textarea id="currentGuiSheetPage" name="currentGuiSheetPage" style="display:none">gui</textarea>
...
function returnToIndex(){
	alert("hello");
	currentGuiSheetPage.value="indexGui";
	alert(currentGuiSheetPage.value);
	$('#indexButton').click();
}

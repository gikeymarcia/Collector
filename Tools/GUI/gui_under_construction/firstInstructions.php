...
*/
   ...
   // require '../Code/initiateCollector.php';
	...
	$guiStruc->studyName = $_DATA['guiSheets']['studyName'];
...
<form action="index.php" method="post" onsubmit="return getContent()">
	<textarea id="currentGuiSheetPage" name="currentGuiSheetPage" style="display:none">firstTask</textarea>

  ...
  foreach($trialTypeElementsPhp->elements as $elementKey=>$element){
    ...
    if (isset($element->textColor)){
      echo "color:$element->textColor;
            ...
            font-size:".(3*$element->textSize)."px;"; // 
    }
  ...
  <table>
    <tr title="What actions to other elements do you want when clicking on this element? E.G. hide'(element1)'">
      ...
      <td>
        ...
        <select id="clickOutcomesElementId" onchange="adjustClickOutcomes(); supportClickOutcomes">
          <option></option>
        </select>
...
function adjustTextBack(){
  ...
  if(textBackId.value==""){
    trialTypeElements['elements'][currentElement]['textBack']="default";
  } else {
...
function adjustTextColor(){
  ...
  if(textColorId.value==""){
    trialTypeElements['elements'][currentElement]['textColor']="default";
  } else {
...
function adjustTextFont(){
  ...
  if(textFontId.value==""){
    trialTypeElements['elements'][currentElement]['textFont']="default";
  } else {
...
//    spanArray[elementNo]={type:inputElementType};
    ...
    trialTypeElements['elements'][elementNo] = {
      ...
      if(inputElementType=="text" | inputElementType=="input"){
        ...
        trialTypeElements['elements'][elementNo]['textColor']="default";
        trialTypeElements['elements'][elementNo]['textFont']="default";
        trialTypeElements['elements'][elementNo]['textBack']="default";
...
function loadConfigs(){
  ...
  //alert(trialTypeElements['elements'].length);
  
  
  
  //wipe all the options in the select input
  
  
  //using the function:
  
  // code dependent on whether it's a response option or not
  if (document.getElementById("clickOutcomesActionId").value=="response"){
    // give response value
    //$("#").show();
  } else {
